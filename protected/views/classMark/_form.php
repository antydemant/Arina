...
<div class="form">
    ...
    <?php
    //echo $form->textFieldRow($model, 'actual_class_id', array('style' => 'display: none', 'labelOptions' => array('label' => false)));
    ?>

    <?php echo $form->textFieldRow($model, 'mark'); ?>

    <?php
    //echo $form->textFieldRow($model, 'student_id', array('style' => 'display: none', 'labelOptions' => array('label' => false)));
    ?>
