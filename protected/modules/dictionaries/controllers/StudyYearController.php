...
//	}
	...
	{
		$dataProvider=new CActiveDataProvider('StudyYear');
	...
	{
		$model=new StudyYear('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['StudyYear']))
			$model->attributes=$_GET['StudyYear'];
	...
	{
		$model=StudyYear::model()->findByPk($id);
		if($model===null)
